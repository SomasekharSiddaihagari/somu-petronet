...
class HsnDigitalLogBookCreate(BaseModel):
    ...
    sv5: Optional[str] = None
    sv6: Optional[str] = None
    sv7: Optional[str] = None
    ms_logbook_id: Optional[int] = None

class HsnDigitalLogBookUpdate(BaseModel):
    logbook_ref_no: Optional[str] = None
...
class HsnDigitalLogBookResponse(BaseModel):
    hsn_logbook_id: int
