# app/schemas/erv_c_shift_log_schema.py
from pydantic import BaseModel
from typing import Optional
from datetime import date, datetime, time


class ERVCShiftLogBase(BaseModel):
...
class ERVCShiftLogCreate(ERVCShiftLogBase):
    pass


class ERVCShiftLogUpdate(ERVCShiftLogBase):
    pass
