# app/schemas/erv_a_shift_log_schema.py
from pydantic import BaseModel
from typing import Optional
from datetime import date, datetime, time


class ERVAShiftLogBase(BaseModel):
...
class ERVAShiftLogCreate(ERVAShiftLogBase):
    pass


class ERVAShiftLogUpdate(ERVAShiftLogBase):
    pass
