...
class WorkAtHeightElectricalIsolationBase(BaseModel):
    whp_id: Optional[int] = None
...
class WorkAtHeightElectricalIsolationCreate(WorkAtHeightElectricalIsolationBase):
    created_by: int                            # ← required on create


class WorkAtHeightElectricalIsolationUpdate(WorkAtHeightElectricalIsolationBase):
    pass