...
class CompositeWorkPermitSchema(BaseModel):
    cwp_id: int

    serial_number: Optional[str] = None
    type_of_permit: Optional[str] = "Composite Work"
    ...
    a1_sub_equipment: Optional[bool] = None
    a1_sub_work_area: Optional[bool] = None

    a2_surrounding_area_checked: Optional[str] = None

    a3_sewers_manholes_covered: Optional[str] = None
    a3_sub_sewers: Optional[bool] = None
    a3_sub_manholes: Optional[bool] = None
    a3_sub_cbd: Optional[bool] = None
    a3_sub_hot_surface: Optional[bool] = None
    a3_sub_other: Optional[bool] = None
    ...
    a6_sub_steamed: Optional[bool] = None
    a6_sub_purged: Optional[bool] = None

    a7_equipment_blinded_isolated: Optional[str] = None
    a7_sub_blinded: Optional[bool] = None
    a7_sub_disconnected: Optional[bool] = None
    a7_sub_closed: Optional[bool] = None
    a7_sub_isolated: Optional[bool] = None
    a7_sub_wedge_opened: Optional[bool] = None

    a8_equipment_water_flushed: Optional[str] = None

    a9_iron_sulphide_removed: Optional[str] = None
    a9_sub_sulphide_removed: Optional[bool] = None
    a9_sub_kept_wet: Optional[bool] = None
    ...
    a12_sub_running_water_hose: Optional[bool] = None
    a12_sub_fire_extinguisher: Optional[bool] = None
    a12_sub_fire_water_system: Optional[bool] = None
    ...
    b2_sub_process: Optional[bool] = None
    b2_sub_maint: Optional[bool] = None
    b2_sub_contractor: Optional[bool] = None
    b2_sub_fire_dept: Optional[bool] = None
    ...
    c1_sub_mobile_equipment: Optional[bool] = None
    c1_sub_vehicle_provided: Optional[bool] = None

    d1_excavation_clearance_obtained: Optional[str] = None
    d1_sub_excavation: Optional[bool] = None
    d1_sub_road_cutting: Optional[bool] = None
    d1_sub_dyke_cutting: Optional[bool] = None

    hazard_lack_of_o2: Optional[bool] = None
    hazard_lack_of_h2s: Optional[bool] = None
    hazard_toxic_gases: Optional[bool] = None
    hazard_combustible_gases: Optional[bool] = None
    hazard_pyrophoric_iron: Optional[bool] = None
    hazard_corrosive_chemicals: Optional[bool] = None
    hazard_steam_condensate: Optional[bool] = None
    hazard_other: Optional[bool] = None
    hazard_other_text: Optional[str] = None

    ppe_helmet: Optional[bool] = None
    ppe_safety_shoes: Optional[bool] = None
    ppe_hand_gloves: Optional[bool] = None
    ppe_boiler_suit: Optional[bool] = None
    ppe_cotton_coverall: Optional[bool] = None
    ppe_face_shield: Optional[bool] = None
    ppe_fresh_air_mask: Optional[bool] = None
    ppe_dust_respirator: Optional[bool] = None
    ppe_apron: Optional[bool] = None
    ppe_goggles: Optional[bool] = None
    ppe_earmuff: Optional[bool] = None
    ppe_lifeline: Optional[bool] = None
    ppe_safety_belt: Optional[bool] = None
    ppe_airline: Optional[bool] = None
    ppe_other: Optional[bool] = None
...
class CompositeToolboxTalkParticipantSchema(BaseModel):
    cttp_id: int
...
class CompositeToolboxTalkSchema(BaseModel):
    ctt_id: int
    ...
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    participants: List[CompositeToolboxTalkParticipantSchema] = []

    class Config:
        orm_mode = True


class CompositeIsolationPermitSchema(BaseModel):
    ceip_id: int
    composite_work_permit_id: Optional[int] = None
    ...
    equipment_number_to_be_isolated: Optional[str] = None
...
class CompositeEnergizationPermitSchema(BaseModel):
    ceep_id: int
    composite_work_permit_id: Optional[int] = None
    work_permit_number: Optional[str] = None
    work_clearance_time: Optional[time] = None
...
class CompositeWorkPermitDetailSchema(CompositeWorkPermitSchema):
    toolbox_talks: List[CompositeToolboxTalkSchema] = []
    isolation_permits: List[CompositeIsolationPermitSchema] = []
    energization_permits: List[CompositeEnergizationPermitSchema] = []
