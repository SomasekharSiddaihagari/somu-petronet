...
class CompositeElectricalIsolationPermitBase(BaseModel):
...
class CompositeElectricalIsolationPermitCreate(CompositeElectricalIsolationPermitBase):
    created_by: int  # ← required on create


class CompositeElectricalIsolationPermitUpdate(CompositeElectricalIsolationPermitBase):
    pass
