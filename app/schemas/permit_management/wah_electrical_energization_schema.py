...
class WorkAtHeightElectricalEnergizationBase(BaseModel):
...
class WorkAtHeightElectricalEnergizationCreate(WorkAtHeightElectricalEnergizationBase):
    created_by: int                            # ← required on create


class WorkAtHeightElectricalEnergizationUpdate(WorkAtHeightElectricalEnergizationBase):
    pass