...
class SecurityGuardReportLine(Base):
    __tablename__ = "security_guard_report_line"

    sgrl_id = Column(Integer, primary_key=True, index=True)
    ...
    report_id = Column(
        Integer,
        ForeignKey("security_guard_report.security_guard_id", ondelete="CASCADE")
    )
