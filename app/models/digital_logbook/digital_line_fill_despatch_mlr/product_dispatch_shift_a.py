...
class ERVAShiftLog(Base):
    __tablename__ = "a_shift_log"
 
    a_shift_log_id = Column(Integer, primary_key=True, autoincrement=True)
    ...
    category_master_id = Column(
        Integer,
        ForeignKey("product_dispatch_category_master.p_dispatch_id"),
        nullable=True
    )
    ...
    shift_name = Column(String(20), nullable=True)      # A Shift
    ...
    # PRODUCT QUANTITIES
    # ----------------------------
    sko = Column(Float, nullable=True)
