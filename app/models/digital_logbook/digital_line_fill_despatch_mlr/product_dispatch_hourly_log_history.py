from sqlalchemy import Column, Integer, String, Float, Date, Time, DateTime, func
from app.database import Base

class ProductDispatchHourlyLogHistory(Base):
    __tablename__ = "product_dispatch_hourly_log_history"

    history_id = Column(Integer, primary_key=True, autoincrement=True)
    p_dispatch_hour_id = Column(Integer, nullable=True)
