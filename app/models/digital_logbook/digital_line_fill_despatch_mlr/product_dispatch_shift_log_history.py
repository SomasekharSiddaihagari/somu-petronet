...
class ProductDispatchShiftLogHistory(Base):
    __tablename__ = "product_dispatch_shift_log_history"

    history_id = Column(Integer, primary_key=True, autoincrement=True)
    shift_log_id = Column(Integer, nullable=False) # Reference to original record
