...
class ERVCShiftLog(Base):
    __tablename__ = "erv_c_shift_log"
 
    erv_c_shift_log_id = Column(Integer, primary_key=True, autoincrement=True)
    ...
    category_master_id = Column(
        Integer,
        ForeignKey("product_dispatch_category_master.id"),
        nullable=True
    )
    ...
    shift_name = Column(String(20), nullable=True)      # C Shift
