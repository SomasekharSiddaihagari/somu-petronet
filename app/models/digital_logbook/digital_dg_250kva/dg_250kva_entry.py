from sqlalchemy import Column, Integer, Date, Time, Float, String, DateTime, ForeignKey
from sqlalchemy.sql import func
from app.database import Base
 
 
class DG250KVAEntry(Base):
    __tablename__ = "dg_250kva_entry"
 
    dg_entry_id = Column(Integer, primary_key=True,autoincrement=True)
 
    master_id = Column(
        Integer,
        ForeignKey("dg_250kva_master.dg_id", ondelete="CASCADE"),
        nullable=True
    )
