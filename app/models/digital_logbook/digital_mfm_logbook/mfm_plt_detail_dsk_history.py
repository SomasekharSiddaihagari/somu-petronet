...
class MFMPLTDetail(Base):
    __tablename__ = "mfm_plt_detail_dkn_history"
    
    history_id = Column(Integer, primary_key=True, autoincrement=True)
    mfm_plt_dkn_id = Column(Integer, nullable=True)
    ...
    qty_as_per_fmr_net = Column(Float, nullable=True)
    qty_as_per_fmr_gross= Column(Float, nullable=True)
    qty_as_per_fmr_mass= Column(Float, nullable=True)
