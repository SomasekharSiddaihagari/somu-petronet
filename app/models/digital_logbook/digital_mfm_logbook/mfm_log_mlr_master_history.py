...
class MFMLogMLRMasterHistory(Base):
    __tablename__ = "mfm_log_mlr_master_history"

    history_id = Column(Integer, primary_key=True, autoincrement=True)
    mfm_log_mlr_id = Column(Integer, nullable=True)
    ...
    flow_meter = Column(String(50), nullable=True)
