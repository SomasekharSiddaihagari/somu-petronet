# app/models/digital_logbook/digital_cp_reading/cp_reading_mlr_entry_history.py
from sqlalchemy import Column, Integer, String, Date, Time, DateTime
from sqlalchemy.sql import func
from app.database import Base


class CPReadingMLREntryHistory(Base):
    __tablename__ = "cp_reading_mlr_entry_history"

    history_id = Column(Integer, primary_key=True, autoincrement=True)
    cp_mlr_entry_id = Column(Integer, nullable=True)
