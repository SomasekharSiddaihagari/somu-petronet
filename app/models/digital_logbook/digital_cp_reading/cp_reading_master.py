# app/models/digital_logbook/digital_cp_reading/cp_reading_master.py
from sqlalchemy import Column, Integer, String, Date, Time, DateTime
from sqlalchemy.sql import func
from app.database import Base

class CPReadingMaster(Base):
    __tablename__ = "cp_reading_master"

    cp_master_id = Column(Integer, primary_key=True, autoincrement=True)
    station_id = Column(Integer, nullable=False, index=True)   # 1=MLR 2=NER 3=HSN 4=DKN
