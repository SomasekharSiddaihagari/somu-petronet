...
class CPReadingEntryHistory(Base):
    __tablename__ = "cp_reading_entry_history"

    history_id = Column(Integer, primary_key=True, autoincrement=True)
    cp_entry_id = Column(Integer, nullable=False, index=True) # Original ID
    master_id = Column(Integer, nullable=False, index=True) # Original FK
