...
class VibrationTemperatureEntry(Base):
    __tablename__ = "vibration_temperature_entry"
 
    vte_id = Column(Integer, primary_key=True, autoincrement=True)
    ...
    master_id = Column(
        Integer,
        ForeignKey("vibration_temperature_master_mlr.vtm_id"),
        nullable=True
    )
