...
class MFMAccountingHSN(Base):
    __tablename__ = "mfm_accounting_hsn"
 
    mfm_acc_hsn_id = Column(Integer, primary_key=True, autoincrement=True)
 
    # Header
    station = Column(String(50), nullable=True)              # Hassan
