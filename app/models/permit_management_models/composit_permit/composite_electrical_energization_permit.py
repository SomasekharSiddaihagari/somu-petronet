...
class CompositeElectricalEnergizationPermit(Base):
    __tablename__ = "composite_electrical_energization_permit"
 
    ceep_id = Column(Integer, primary_key=True, autoincrement=True)
