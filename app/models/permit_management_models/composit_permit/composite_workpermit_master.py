from sqlalchemy import Column, Integer, String, Date, Time, DateTime, Boolean, Text, Float, func, ForeignKey
from app.database import Base
from datetime import datetime

class CompositeWorkPermit(Base):
    __tablename__ = "composite_work_permit"

    cwp_id = Column(Integer, primary_key=True, autoincrement=True)
