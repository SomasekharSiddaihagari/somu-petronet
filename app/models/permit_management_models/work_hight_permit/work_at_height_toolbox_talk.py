...
class WorkAtHeightToolboxTalk(Base):
    __tablename__ = "work_at_height_toolbox_talk"
 
    whtt_id = Column(Integer, primary_key=True, autoincrement=True)
 
    # ---------------------------------
    # FK TO WORK AT HEIGHT PERMIT
    # ---------------------------------
    work_at_height_permit_id = Column(
        Integer,
