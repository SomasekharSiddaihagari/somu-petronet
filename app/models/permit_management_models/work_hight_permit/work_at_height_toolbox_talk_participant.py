...
class WorkAtHeightToolboxTalkParticipant(Base):
    __tablename__ = "work_at_height_toolbox_talk_participant"
 
    whttp_id = Column(Integer, primary_key=True, autoincrement=True)
    ...
    toolbox_talk_id = Column(
        Integer,
        ForeignKey("work_at_height_toolbox_talk.whtt_id"),
        nullable=True
    )
