...
class WorkAtHeightElectricalIsolationPermit(Base):
    __tablename__ = "work_at_height_electrical_isolation_permit"
 
    whpis_id = Column(Integer, primary_key=True, autoincrement=True)
