...
class CircularMaster(Base):
    __tablename__ = "circular_master"
    circular_id = Column(Integer, primary_key=True,autoincrement=True)
    ...
    subcategory_id = Column(Integer, ForeignKey("subcategory_master.subcategory_id"),nullable=True)
