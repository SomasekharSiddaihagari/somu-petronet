...
# class InwardGatePassPhoto(Base):    
#     __tablename__ = "inward_gate_pass_photos"
...
#     def __repr__(self):
#         return f"<InwardGatePassPhoto(id={self.id}, inward_id={self.inward_id}, uploaded_by='{self.uploaded_by}')>"
...
class InwardGatePassPhoto(Base):
    ...
    vehicle_photo = Column(String(255))
    delivery_personnel_photo = Column(String(255))
    delivery_personnel_id_photo = Column(String(255))
