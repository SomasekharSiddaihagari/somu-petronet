...
class LeaveEncashmentHistory(Base):
    __tablename__ = "leave_encashment_history"
 
    leave_encashment_history_id = Column(
        BigInteger, primary_key=True, autoincrement=True
    )
 
    leave_encashment_id = Column(BigInteger, nullable=True)
