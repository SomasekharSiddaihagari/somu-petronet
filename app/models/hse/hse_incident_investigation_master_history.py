import datetime
from sqlalchemy import Column, DateTime, Integer, String, Date, Time, Text, Boolean
from sqlalchemy.ext.declarative import declarative_base
 
Base = declarative_base()
 
 
class HSEIncidentInvestigationMasterHistory(Base):
    __tablename__ = "hse_incident_investigation_master_history"
