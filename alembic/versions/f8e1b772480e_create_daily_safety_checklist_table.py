"""create daily safety checklist table

Revision ID: f8e1b772480e
Revises: 96b5fc73bbeb
Create Date: 2026-01-19 21:22:34.041399
...
revision: str = 'f8e1b772480e'
down_revision: Union[str, Sequence[str], None] = '96b5fc73bbeb'
...
def upgrade():
    op.create_table(
        ...
        sa.Column("dsc_id", sa.Integer(), primary_key=True, autoincrement=True),
        ...
        # ---------------- Section F – ALL AREAS ----------------
        # (Area I, II, III – ALL INCLUDED, NOT SHORTLISTED)
        ...
        # Area II
        sa.Column("f_ii_1_no_ignition_sources_visible", sa.Boolean()),
        sa.Column("f_ii_1_remarks", sa.Text()),
        sa.Column("f_ii_2_all_electrical_connections_safe", sa.Boolean()),
        sa.Column("f_ii_2_remarks", sa.Text()),
        sa.Column("f_ii_3_sprinkler_system_working", sa.Boolean()),
        sa.Column("f_ii_3_remarks", sa.Text()),
        sa.Column("f_ii_4_housekeeping_in_order", sa.Boolean()),
        sa.Column("f_ii_4_remarks", sa.Text()),
        sa.Column("f_ii_5_ows_tank_farm_functional", sa.Boolean()),
        sa.Column("f_ii_5_remarks", sa.Text()),
        sa.Column("f_ii_6_fire_extinguishers_accessible", sa.Boolean()),
        sa.Column("f_ii_6_remarks", sa.Text()),
        sa.Column("f_ii_7_any_product_leak_or_unsafe_condition", sa.Boolean()),
        sa.Column("f_ii_7_remarks", sa.Text()),
        sa.Column("f_ii_8_fire_water_monitors_hoses_good", sa.Boolean()),
        sa.Column("f_ii_8_remarks", sa.Text()),
        sa.Column("f_ii_9_rovs_on_remote_mode", sa.Boolean()),
        sa.Column("f_ii_9_remarks", sa.Text()),
        sa.Column("f_ii_10_pressure_temperature_transmitters_functional", sa.Boolean()),
        sa.Column("f_ii_10_remarks", sa.Text()),
        sa.Column("f_ii_11_bonding_across_flanges_visible_intact", sa.Boolean()),
        sa.Column("f_ii_11_remarks", sa.Text()),
        sa.Column("f_ii_12_last_fire_drill_done", sa.Boolean()),
        sa.Column("f_ii_12_remarks", sa.Text()),
        sa.Column("f_ii_13_hydrocarbon_detection_system_working", sa.Boolean()),
        sa.Column("f_ii_13_remarks", sa.Text()),

        # Area III
        sa.Column("f_iii_1_no_ignition_sources_visible", sa.Boolean()),
        sa.Column("f_iii_1_remarks", sa.Text()),
        sa.Column("f_iii_2_all_electrical_connections_safe", sa.Boolean()),
        sa.Column("f_iii_2_remarks", sa.Text()),
        sa.Column("f_iii_3_sprinkler_system_working", sa.Boolean()),
        sa.Column("f_iii_3_remarks", sa.Text()),
        sa.Column("f_iii_4_housekeeping_in_order", sa.Boolean()),
        sa.Column("f_iii_4_remarks", sa.Text()),
        sa.Column("f_iii_5_ows_tank_farm_functional", sa.Boolean()),
        sa.Column("f_iii_5_remarks", sa.Text()),
        sa.Column("f_iii_6_fire_extinguishers_accessible", sa.Boolean()),
        sa.Column("f_iii_6_remarks", sa.Text()),
        sa.Column("f_iii_7_any_product_leak_or_unsafe_condition", sa.Boolean()),
        sa.Column("f_iii_7_remarks", sa.Text()),
        sa.Column("f_iii_8_fire_water_monitors_hoses_good", sa.Boolean()),
        sa.Column("f_iii_8_remarks", sa.Text()),
        sa.Column("f_iii_9_rovs_on_remote_mode", sa.Boolean()),
        sa.Column("f_iii_9_remarks", sa.Text()),
        sa.Column("f_iii_10_pressure_temperature_transmitters_functional", sa.Boolean()),
        sa.Column("f_iii_10_remarks", sa.Text()),
        sa.Column("f_iii_11_bonding_across_flanges_visible_intact", sa.Boolean()),
        sa.Column("f_iii_11_remarks", sa.Text()),
        sa.Column("f_iii_12_last_fire_drill_done", sa.Boolean()),
        sa.Column("f_iii_12_remarks", sa.Text()),
        sa.Column("f_iii_13_hydrocarbon_detection_system_working", sa.Boolean()),
        sa.Column("f_iii_13_remarks", sa.Text()),
...
def downgrade():
    op.drop_table("daily_safety_checklist")
